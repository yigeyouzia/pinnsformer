...
参数:
    loss_track : list of [loss_res, loss_bc, loss_ic] 或 [loss_res, loss_bc, loss_ic, ...]
    save_path  : 保存路径，默认 './loss_curve.png'
    title      : 图标题，默认 'Training Loss'
    labels     : 自定义标签列表，默认 ['Loss_Res', 'Loss_BC', 'Loss_IC', ...]
"""
import numpy as np
...
def plot_loss(loss_track, save_path='./loss_curve.png', title='Training Loss',
    ...
    if labels is None:
        default_labels = ['Loss_Res', 'Loss_BC', 'Loss_IC',
                          'Loss_IC2', 'Loss_Data']
